<template>
  <nav class="Affix" >
    ...
    <!--<ul class="Affix__List">-->
      ...
      <!--</li>-->
      <!--<li class="Affix__List__Item">-->
        <!--&lt;!&ndash;{{ $store.state.lang.sponsors.become }}&ndash;&gt;-->
        <!--&lt;!&ndash;<a href="https://opencollective.com/nuxtjs" target="_blank" rel="noopener">{{ $store.state.lang.sponsors.become_partner }}</a>.&ndash;&gt;-->
        <!--<a href="https://opencollective.com/nuxtjs" target="_blank" rel="noopener">become_partner</a>.-->
      <!--</li>-->
    <!--</ul>-->
